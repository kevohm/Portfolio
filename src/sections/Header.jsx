...
import cv from "../assets/Kevin-Kipkemboi-CV.pdf";
            ...
            <div className="relative px-4 sm:px-8 lg:px-12">
              <div className="mx-auto max-w-2xl lg:max-w-5xl">
                <div className="relative flex gap-4">
                  ...
                  <ul role="list" className="flex gap-2.5 pointer-events-auto">
                    <li className="flex">
                      <a
                        target="_blank "
                    ...
                    <li className=" dark:border-zinc-700/40 flex">
                      <a
                        target="_blank "
                        className="group flex text-sm font-medium text-zinc-800 transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500"
                        href="mailto:kevinkipkibet@gmail.com"
                      >
                        <MailIcon  className="h-6 w-6 flex-none text-zinc-500 transition group-hover:text-teal-500" />
                        {/* <span className="ml-4">kevinkipkibet@gmail.com</span> */}
                      </a>
                    </li>
                  </ul>
                  {/* <NavBar/>
