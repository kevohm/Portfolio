                    ...
                    >
                      {projects.map((project,index) => {
                        return (
                          ...
                          >
                            <Link to={`/projects/${project.title.toLowerCase().replace(/\s+/g, '-')}`} className="">
                            ...
                            <a target="_blank" className="relative z-10 mt-6 flex text-sm font-medium text-zinc-400 transition group-hover:text-teal-500 dark:text-zinc-200" href={project.url}>
